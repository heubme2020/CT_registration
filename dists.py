...
class DISTS(torch.nn.Module):
    def __init__(self, load_weights=True):
        ...
        vgg_pretrained_features.load_state_dict(torch.load('vgg16_features.pth'))
    ...
    def forward(self, x, y, require_grad=False, batch_average=True):
        if require_grad:
